...
const globalstyles = StyleSheet.create({
  ...
  textInput_SubHeader: { color: Colors.grey, fontFamily: 'Lato-Regular', fontSize: Normalize(11), marginBottom: Normalize(3) },
  forgotpassBtnText: {
    fontSize: Normalize(11.5),
    color: "#6F7074",
    fontFamily: 'Lato-Regular',
  ...
  currency_font_bold: { fontFamily: "Outfit-Bold", fontSize: Normalize(15), color: "#4c5166", opacity: 0.8 },
  pleaseNote_font: {
    fontFamily: 'Lato-Bold',
    color: Colors.primary,
    fontSize: Normalize(11),
