...
export default function ListingFilterCategorySelect(props) {
    const navigation = useNavigation()

    const {
        listing_Categories, setListing_Categories
    } = useContext(myContext);
    const [f_ategories_temp, setF_ategories_temp] = useState(listing_Categories)
        ...
        <View
            ...
            <View
                ...
                </ScrollView>
                {
                    ...
                    <Button
                        onPress={() => {
                            setListing_Categories(f_ategories_temp)
                            setF_ategories_temp([])
                            navigation.goBack()
                        }}
                        name='Save'
