...
import { View, Text, TouchableOpacity, Image, ScrollView, TextInput, SafeAreaView, Dimensions, Pressable, FlatList, KeyboardAvoidingView, Platform } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ backgroundColor: Colors.primary, flex: 1, flexDirection: 'column' }}>
      ...
      <KeyboardAvoidingView
        ...
        <Header navigation={navigation} back name={strings.HELPTOPICS.HELP} />
