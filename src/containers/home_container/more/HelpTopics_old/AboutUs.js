                     ...
                     />
                      ...
                      <View style={{ flexDirection: rowOrRowreverse(language), marginVertical: 20, justifyContent: 'space-between' }}>
                        <View style={{
                          ...
                          <Text style={{
                            fontSize: Normalize(13), color: '#444', alignSelf: 'center', fontFamily: "Outfit-Regular"
                      ...
                      />
                      <Text style={{ fontSize: Normalize(14), color: '#555', marginTop: Normalize(10), fontFamily: "roboto-SemiBold" }}>{data.caption_about_title}</Text>
                      <HTMLView
                      ...
                      <View style={{ flexDirection: 'column', marginVertical: 20 }}>
                        ...
                        <View style={{
                          ...
                          <Text style={{
                            ...
                            alignSelf: 'center', fontFamily: "Outfit-Medium"
                      ...
                      <ModalVideoView />
                      <Text style={{ fontSize:Normalize(16), color: '#555', marginTop: Normalize(10), fontFamily: "Outfit-Medium" }}>{language == "en" ? "Frequently asked questions" : "سوالات متداول"}</Text>
                      <View style={{}} >
                        {
                          faq.map((item, index) => (
                            <View key={index} >
                              <TouchableOpacity
                                ...
                                <Text style={{ fontSize: Normalize(13), color: Colors.primary, fontFamily: "Outfit-Medium" }}>{item.faq_detail_api.question}</Text>
