                  ...
                  >
                    ...
                    <View style={{ backgroundColor: Colors.white, elevation:Normalize(2), width: "99%", alignSelf: "center", borderRadius: 8, padding: Normalize(10), marginTop: Normalize(15), marginBottom: Normalize(40) }}>
                      ...
                      <View style={{ flexDirection: rowOrRowreverse(language), marginTop: Normalize(15), alignItems: "center" }} >
                        ...
                        <Text style={{ fontSize: Normalize(14), fontFamily: whichFontFamily(language), textAlign: language == "en" ? "left" : "right", marginHorizontal: Normalize(5), }}>{language == "en" ? "ADDRESS" : "آدرس"}</Text>
                      </View>

                      <Text style={{ marginLeft: Normalize(27), color: '#777', marginTop: Normalize(8), fontSize: Normalize(11), fontFamily: "Outfit-Regular", textAlign: language == "en" ? "left" : "right" }}>{address}</Text>
                      <View style={{ flexDirection: rowOrRowreverse(language), marginTop: Normalize(15), alignItems: "center" }} >
                        <View style={{ height: Normalize(25), width: Normalize(25), backgroundColor: Colors.green2, borderRadius: Normalize(25) / 2, justifyContent: "center", alignItems: "center" }} >
                          <Image source={images.email_p} style={{ height: "100%", width: "100%", resizeMode: "contain" }} />
                        </View>
                        <Text style={{ fontSize: Normalize(14), fontFamily: whichFontFamily(language), textAlign: language == "en" ? "left" : "right", marginHorizontal: Normalize(5), }}>{strings.BASICINFO.EMAIL}</Text>
                      </View>
                      <Text style={{ marginLeft: Normalize(27), color: '#777', marginTop: Normalize(8), fontSize: Normalize(11), fontFamily: "Outfit-Regular", textAlign: language == "en" ? "left" : "right" }}>{emailforshow}</Text>

                      <View style={{ flexDirection: rowOrRowreverse(language), marginTop: Normalize(15), alignItems: "center" }} >
                        <View style={{ height: Normalize(25), width: Normalize(25), backgroundColor: Colors.green2, borderRadius: Normalize(25) / 2, justifyContent: "center", alignItems: "center" }} >
                          <Image source={images.phone_p} style={{ height: "100%", width: "100%", resizeMode: "contain" }} />
                        </View>
                        <Text style={{ fontSize: Normalize(14), fontFamily: whichFontFamily(language), textAlign: language == "en" ? "left" : "right", marginHorizontal: Normalize(5), }}>{language == "en" ? "CONTACT NUMBER" : "شماره تماس"}</Text>
                      </View>

                      <Text style={{ marginLeft: Normalize(27), color: '#777', marginTop: Normalize(8), fontSize: Normalize(11), fontFamily: "Outfit-Regular", textAlign: language == "en" ? "left" : "right" }}>
                        +{addCommaAndTranslateInPersian(phonecode, language)} {language == "en" ? numberforshow : engToPersian(numberforshow)}
                      </Text>

                      <Text style={{ fontSize: Normalize(14), marginTop: Normalize(15), fontFamily: whichFontFamily(language), textAlign: language == "en" ? "left" : "right" }}>{language == "en" ? "CONNECT WITH SOCIAL MEDIA" : "رسانه های اجتماعی"}</Text>
