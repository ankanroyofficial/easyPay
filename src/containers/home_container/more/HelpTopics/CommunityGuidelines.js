              ...
              <View style={{flex: 1, backgroundColor: Colors.white}}>
                ...
                <View style={{flex: 1}}>
                  <CurveDesing_Component>
                    {/* Policies for you common member */}
                    <View style={globalstyles.container_only_padding}>
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            navigation.navigate('CommunityGuidelinesTasker')
                          }>
                          <Text
                            style={{
                          ...
                          <Text
                            ...
                            {language == 'en'
                              ? data.tasker_description
                              : data.tasker_description_fa}
                          </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          style={{
                          ...
                          onPress={() =>
                            navigation.navigate('CommunityGuidelinesPoster')
                          }>
                          <Text
                            style={{
                              fontSize: Normalize(14),
                          ...
                          <Text
                            ...
                            {language == 'en'
                              ? data.poster_description
                              : data.poster_description_fa}
                          </Text>
                        </TouchableOpacity>
                      </View>
                      <Image
