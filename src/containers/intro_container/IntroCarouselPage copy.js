                            ...
                            introDetails.map((item, index) => {
                                return (
                                    <View key={index} style={{ width: width, height: "100%", alignItems: "center", justifyContent: "space-between", paddingTop: Normalize(40), paddingBottom: Normalize(15) }} >
                                        ...
                                        <Animated.View style={{ height: height * 0.4, width: "85%", transform: [{ scale: imageValue }] }}>
                                            <Image source={item.image} style={{ height: "100%", width: "100%", resizeMode: "contain" }} />
                                        </Animated.View>
                                        <Animated.Text style={{ color: Colors.white, fontSize: Normalize(14), lineHeight: Normalize(18), textAlign: "center", fontFamily: 'Lato-Regular', transform: [{ scale: imageValue }] }} >{item.description}</Animated.Text>
                                    </View>
                                )
                            })
                        }
